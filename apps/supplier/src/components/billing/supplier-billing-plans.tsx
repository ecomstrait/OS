...
import { SUPPLIER_PLAN_ENTITLEMENTS, PLAN_ORDER } from "@ecomstrait/db";
...
export function SupplierBillingPlans({
  currentPlan,
  hasCustomer,
}: {
            ...
            >
              ...
              <ul className="mt-4 flex flex-1 flex-col gap-2 text-sm text-ink-600">
                ...
                <li className="flex items-center gap-2">
                  ...
                  {p.productLimit === null ? "Unlimited products" : `${fmt(p.productLimit)} products`}
                </li>
              </ul>
              <div className="mt-5">
                {tier === "free" ? (
